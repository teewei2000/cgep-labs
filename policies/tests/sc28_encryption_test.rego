...
# opa test -> is my policy correct?
# opa eval -> is this terraform plan compliant?
...
# naming convention for "test" in OPA
# OPA will find rules whose names start with test_ and execite them automatically
