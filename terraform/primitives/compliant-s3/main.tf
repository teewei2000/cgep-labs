...
#That last resource, aws_s3_bucket_logging, is the line that actually wires AU-3. It tells the primary bucket to send its access logs to the log bucket. 
# Without it you'd have two buckets and no audit trail between them.
